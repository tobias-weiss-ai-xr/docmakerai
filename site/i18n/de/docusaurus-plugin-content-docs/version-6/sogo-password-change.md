...
description: "So ändern Sie Ihr SOGo 6-Passwort"
sidebar_label: "Passwort ändern"
---

# Passwort ändern

Aktualisieren Sie Ihr SOGo 6-Kontopasswort, um Ihr Konto sicher zu halten.
...
## Methoden zur Passwortänderung

Die Passwortänderung in SOGo 6 hängt von der Konfiguration Ihrer Organisation ab:
...
5. Geben Sie Ihr neues Passwort zweimal ein, um es zu bestätigen
6. Klicken Sie auf **Passwort ändern** oder **Speichern**

:::tip
Die meisten Organisationen verwenden einen externen Identitätsanbieter für Passwortänderungen. Fragen Sie Ihren IT-Support nach der korrekten Methode.
:::
...
| **Verlauf** | Die letzten 3 Passwörter können nicht wiederverwendet werden |
| **Ablauf** | Änderung alle 90 Tage (übliche Richtlinie) |
...
:::warning
Wenn Sie Ihr Passwort aufgrund einer Kontosperrung nicht ändern können, kontaktieren Sie Ihren Administrator oder IT-Support.
:::

## Fazit

Sie haben erfolgreich gelernt, wie Sie Ihr SOGo 6-Passwort ändern.
## Barrierefreiheit
