...
Anders als beim [iCal-Import/Export](./sogo-calendar-ical) abonnieren Sie hier
einen lebenden Feed, der sich bei jeder Anmeldung automatisch aktualisiert —
und kein einmaliger Datei-Import ist.
