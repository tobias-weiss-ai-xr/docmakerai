...
Organisieren Sie Ihre E-Mails mit Ordnern zum Archivieren und für schnellen Zugriff.
...
Die Ordnerliste zeigt Ihre Standardordner:

- **Posteingang** — Empfängt eingehende E-Mails
- **Gesendet** — Enthält von Ihnen gesendete E-Mails
...
### Schritt 4: E-Mails zwischen Ordnern verschieben

#### Methode 1: Ziehen und Ablegen
1. Klicken Sie auf die E-Mail, die Sie verschieben möchten
...
:::info
Ordneränderungen werden sofort mit dem Server synchronisiert. Ihre Ordnerstruktur ist auf allen Geräten konsistent.
:::
