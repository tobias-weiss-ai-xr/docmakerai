---
title: "Search"
description: "Search your emails, contacts, and calendar in SOGo 5"
sidebar_label: "Search"
---

import PageSEO from '@site/src/components/PageSEO';

<PageSEO title="Search" description="Step-by-step tutorial to search emails, contacts, and calendar events in SOGo 5" keywords={["search", "find", "modules", "quick access"]} />

# Search in SOGo 5

Searching in SOGo 5 works per module: search emails in the Mail module, contacts in the Address Book, and calendar events in the Calendar — each via the search field of that surface.
...
![Searching in SOGo 5](./assets/global-search.png)
