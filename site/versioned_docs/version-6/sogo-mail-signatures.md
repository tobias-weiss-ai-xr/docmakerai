...
Enter your signature text in the **Signature** field. SOGo 6 supports **plain text** signatures.
...
**mail-signatures.png:** This 3-second animated GIF shows creating a new email identity (with its signature) in SOGo 6.
