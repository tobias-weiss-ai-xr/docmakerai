...
**[calendar-share.png]:** Animated demonstration of sharing a calendar with a colleague in SOGo 6.

- **Frame 1 (0–1.5s):** User clicks the three-dot menu (⋯) next to the "Personal" calendar in the top navigation and selects **Properties** from the context menu
