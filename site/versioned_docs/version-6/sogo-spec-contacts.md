...
<PageSEO title="Contacts — Spec-Based Guide" description="Spec-based guide covering SOGo contacts module workflows including add, edit/delete, and import/export operations." keywords="SOGo 6, contacts, address book, vCard, import, export, spec" />
...
SOGo 6 supports full keyboard navigation for contacts features.
