...
<PageSEO title="Mail — Spec-Based Guide" description="Spec-based guide covering SOGo mail module workflows including compose, read, reply, forward, delete, folders, filters, and signatures." keywords="SOGo 6, mail, email, compose, reply, forward, folders, filters, signatures, spec" />
...
SOGo 6 supports full keyboard navigation for mail features.
