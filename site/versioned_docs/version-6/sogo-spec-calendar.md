...
<PageSEO title="Calendar — Spec-Based Guide" description="Spec-based guide covering SOGo calendar module workflows including event creation, recurring events, sharing, subscriptions, and free/busy lookup." keywords="SOGo 6, calendar, events, recurring, sharing, iCal, free/busy, spec" />
...
SOGo 6 supports full keyboard navigation for calendar features.
