...
![Configuring weekly recurrence in SOGo 5](./assets/calendar-recurring.png)
...
**calendar-recurring.png:** Screenshot showing the recurring event configuration dialog.
